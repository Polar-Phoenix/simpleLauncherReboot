...
procedure TFormUpdater.ButtonDownloadClick(Sender: TObject);
var
  ZipPath: String;
begin
  ZipPath := Paths.Updates + 'simpleLauncher.zip';
...
procedure TFormUpdater.ButtonViewChangesClick(Sender: TObject);
var
  List: TStringList;
begin
...
procedure TFormUpdater.DownloadHandlerFinish(var Message: TMessage);
begin
  with ProgressBar do
  begin
    Max := 0;
...
procedure TFormUpdater.DownloadHandlerIdle(var Message: TMessage);
var
  Data: TDownloadData;
begin
...
procedure TFormUpdater.DownloadHandlerStart(var Message: TMessage);
begin
  //
end;
